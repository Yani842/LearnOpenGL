...
int main() {
  ...
  // ------------------------------------
  Shader lightingShader("data/shaders/light_casters.vs",
                        "data/shaders/light_casters.fs");
  Shader lightCubeShader("data/shaders/light_cube.vs",
                         "data/shaders/light_cube.fs");
  ...
  // organized)
  // -----------------------------------------------------------------------------
  unsigned int diffuseMap = loadTexture("data/textures/container2.png");
  unsigned int specularMap =
      loadTexture("data/textures/container2_specular.png");
  #pragma endregion
